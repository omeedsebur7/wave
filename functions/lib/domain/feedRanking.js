...
exports.VIEW_SMOOTHING = exports.FOLLOW_BOOST = exports.HALF_LIFE_HOURS = void 0;
exports.rankScore = rankScore;
/**
 ...
 * data arrives.
 */
exports.HALF_LIFE_HOURS = 48;
exports.FOLLOW_BOOST = 1.15;
/** Smoothing constant. See [rankScore]. */
exports.VIEW_SMOOTHING = 50;
/**
 ...
 */
function rankScore(input, nowMs) {
    const engagementRate = (input.likes + input.comments * 2) /
        Math.max(input.views + exports.VIEW_SMOOTHING, 1);
    const ageHours = Math.max(0, (nowMs - input.createdAtMs) / (1000 * 60 * 60));
    const recencyDecay = Math.pow(0.5, ageHours / exports.HALF_LIFE_HOURS);
    const boost = input.authorIsPopular ? exports.FOLLOW_BOOST : 1;
    return Number((engagementRate * recencyDecay * boost).toFixed(6));
}
//# sourceMappingURL=feedRanking.js.map